(() => {
    ...
    function initSliders() {
        if (document.querySelector(".fetured-catalog__slider")) new core(".fetured-catalog__slider", {
            ...
            loop: true,
            pagination: {
                el: ".controll-swiper__dotts, swiper-pagination",
                clickable: true,
        ...
        if (document.querySelector(".product-slider")) new core(".product-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
